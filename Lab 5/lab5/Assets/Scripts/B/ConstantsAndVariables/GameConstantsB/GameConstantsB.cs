...
[CreateAssetMenu(fileName = "GameConstantsB", menuName = "ScriptableObjects/GameConstantsB", order = 1)]
public class GameConstantsB : ScriptableObject
{
    // for Scoring system
    int currentScore;
